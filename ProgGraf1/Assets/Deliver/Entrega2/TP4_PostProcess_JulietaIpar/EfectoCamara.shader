	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float4 temp_output_14_0 = ( ( abs( sin( ( ( _Time.y * 16.9 ) + ( ase_screenPosNorm.y * 29.28 ) ) ) ) * 0.16 ) * color15 );
				...
				float4 lerpResult33 = lerp( ( ( temp_output_14_0 + tex2D( _MainTex, texCoord19 ) ) * ( 1.0 - smoothstepResult23 ) ) , color29 , 0.3080571);
...
/*ASEBEGIN
Version=18900
267;73;1383;665;27.24335;310.6216;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;61;-267.6823,63.11944;Inherit;False;736.3922;604.0964;Efecto de vignette para la cámara;8;2;24;22;25;1;20;21;19;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.Vector2Node;21;-113.5998,457.9333;Inherit;False;Constant;_Center;Center;0;0;Create;True;0;0;0;False;0;False;0.5,0.5;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;20;48.99873,334.885;Inherit;False;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;24;160.1073,433.2032;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;0.3;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;1;-98.92684,118.2755;Inherit;False;0;0;_MainTex;Shader;False;0;5;SAMPLER2D;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LengthOpNode;22;242.3594,334.8853;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;160.1073,525.4881;Inherit;False;Constant;_Float1;Float 1;0;0;Create;True;0;0;0;False;0;False;0.7;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2;69.74603,113.1194;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=183E292321A7C8F962F5A2982D9734E6F24FBAE2