...
Shader "IntersectionEffect"
{
	Properties
	{
		...
		_Color0("Color 0", Color) = (0.8537736,1,0.9629161,0)
		...
		_EmissionIntensity2("EmissionIntensity2", Float) = 1
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( ( pow( saturate( ( 1.0 - abs( ( ( _RippleTime * _RippleSpeed ) - distance( float4( i.uv_texcoord, 0.0 , 0.0 ) , _ImpactUV ) ) ) ) ) , _PowerValue ) * _Color0 ) * _EmissionIntensity2 ) + ( ( ( ( abs( temp_output_66_0 ) * 0.16 ) * _ScreenColour ) * simplePerlin2D75 ) * _EmissionIntensity ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18900
158;73;679;717;-1261.773;241.7301;1.148804;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;28;1041.285,175.199;Inherit;False;Property;_RippleTime;_RippleTime;6;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;48;1053.065,282.212;Inherit;False;Property;_RippleSpeed;RippleSpeed;5;0;Create;True;0;0;0;False;0;False;3;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;53;1718.882,240.628;Inherit;False;Property;_PowerValue;PowerValue;4;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;74;1358.489,1049.008;Inherit;False;Property;_ScreenColour;ScreenColour;10;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.1098487,1,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;73;1045.12,1356.534;Inherit;False;Property;_NoiseScale;NoiseScale;7;0;Create;True;0;0;0;False;0;False;23.8;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;54;1879.252,366.7857;Inherit;False;Property;_Color0;Color 0;3;0;Create;True;0;0;0;False;0;False;0.8537736,1,0.9629161,0;0.8537736,1,0.9629161,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;81;2313.911,580.0232;Inherit;False;Property;_EmissionIntensity2;EmissionIntensity2;9;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;78;1988.725,1491.802;Inherit;False;Property;_EmissionIntensity;EmissionIntensity;8;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=EE46914E76B7DF7B9F343E3BE436868A4BEA52F6